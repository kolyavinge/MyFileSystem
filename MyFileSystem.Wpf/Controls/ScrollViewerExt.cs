...
namespace MyFileSystem.Wpf.Controls
{
    public class ScrollViewerExt : ScrollViewer
    {
        ...
        public static readonly DependencyProperty DynamicHorizontalOffsetProperty =
            DependencyProperty.Register("DynamicHorizontalOffset", typeof(double), typeof(ScrollViewerExt));
        ...
        public static readonly DependencyProperty DynamicVerticalOffsetProperty =
            DependencyProperty.Register("DynamicVerticalOffset", typeof(double), typeof(ScrollViewerExt));
        ...
        public static readonly DependencyProperty DynamicViewportWidthProperty =
            DependencyProperty.Register("DynamicViewportWidth", typeof(double), typeof(ScrollViewerExt));
        ...
        public static readonly DependencyProperty DynamicViewportHeightProperty =
            DependencyProperty.Register("DynamicViewportHeight", typeof(double), typeof(ScrollViewerExt));
